...
function updateSAST() {
    ...
    currentDateTimeGMT2 = new Date(`${dateStr}T${timeStr}`);
    console.log("Current SAST:", currentDateTimeGMT2.toISOString(), "Display:", currentDateTimeGMT2.toLocaleString("en-ZA"));
}
